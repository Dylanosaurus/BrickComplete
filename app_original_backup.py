...
def get_set_inventory(set_number):
    ...
    try:
        ...
        # Store original inventory in our app database for user modifications
        store_original_inventory(set_number, set_info['set_name'], inventory, 
                               set_info['set_image'], set_info['year'], 
                               set_info['num_parts'], set_info['set_url'])
